...
void StartWindow::prepareSettingsMenuElements() {
    ...
    settingsMenuElements.push_back(
            new MenuElement(MenuButtons::CANCEL, Dictionary::CANCEL,
                            {cancelXCoord, elementsYCoord, cancelWidth, elementHeight}));
    settingsMenuElements.push_back(
            new MenuElement(MenuButtons::ACCEPT, Dictionary::ACCEPT,
                            {acceptXCoord, elementsYCoord, acceptWidth, elementHeight}));
}
